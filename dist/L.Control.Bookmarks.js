...
(function (global, factory) {
  ...
  (global = typeof globalThis !== 'undefined' ? globalThis : global || self, (global.L = global.L || {}, global.L.Control = global.L.Control || {}, global.L.Control.Bookmarks = factory(global.L)));
  ...
  GlobalStorage.prototype.removeItem = function removeItem (key, callback) {
    ...
    this.getItem(key, function (item) {
      if (item) {
        delete data[this$1$1._prefix + key];
      } else {
        item = null;
      }
  ...
  LocalStorage.prototype.removeItem = function removeItem (key, callback) {
    ...
    var self = this;
    this.getItem(key, function (item) {
      this$1$1._storage.removeItem(self._prefix + key);
      if (callback) { callback(item); }
    });
  };
   ...
   * @extends {L.Popup}
   */
  var FormPopup = L__default["default"].Popup.extend(
    /** @lends FormPopup.prototype */ {
      ...
      initialize: function (options, source, control, bookmark) {
        ...
        L__default["default"].Popup.prototype.initialize.call(this, options, source);
      },
      ...
      _initLayout: function () {
        L__default["default"].Popup.prototype._initLayout.call(this);

        if (
          this.options.mode === modes.SHOW &&
          (this._bookmark.editable || this._bookmark.removable)
        ) {
          var menuButton = (this._menuButton = L__default["default"].DomUtil.create(
            "a",
          ...
          L__default["default"].DomEvent.disableClickPropagation(menuButton);
          L__default["default"].DomEvent.on(menuButton, "click", this._onMenuButtonClick, this);
        }
      },
      ...
      _onMenuButtonClick: function (evt) {
        L__default["default"].DomEvent.preventDefault(evt);
        this._showMenu();
        this.close();
      },
      ...
      _updateContent: function () {
        ...
        if (this.options.mode === modes.SHOW) {
          ...
          content = substitute(
            template,
            L__default["default"].Util.extend(
              {},
              this._bookmark || {},
        ...
        L__default["default"].Popup.prototype._updateContent.call(this);
        this._onRendered();
      },
      ...
      _onRendered: function () {
        if (
          ...
          L__default["default"].DomEvent.on(form, "submit", this._onSubmit, this);
          setTimeout(this._setFocus.bind(this), 250);
        } else if (this.options.mode === modes.OPTIONS) {
          L__default["default"].DomEvent.delegate(
            this._container,
      ...
      _onSubmit: function (evt) {
        ...
        if (input.value !== "" && validate.call(this, input.value)) {
          var bookmark = L__default["default"].Util.extend(
            {},
            this._bookmark,
      ...
      onAdd: function (map) {
        ...
        return L__default["default"].Popup.prototype.onAdd.call(this, map);
      },
      ...
      onRemove: function (map) {
        ...
        L__default["default"].Popup.prototype.onRemove.call(this, map);
      },
      ...
      _onSourceMoveStart: function () {
        // store
        this._bookmark = L__default["default"].Util.extend(
          this._bookmark || {},
          this._getBookmarkData()
        );
   ...
   * @return {Function}
   */
  L__default["default"].DomEvent.delegate = function (el, selector, type, fn, bind) {
    return L__default["default"].DomEvent.on(el, type, function (evt) {
  ...
  // expose
  L__default["default"].Util._template = L__default["default"].Util._template || substitute;
   ...
   * @extends {L.Control}
   */
  var Bookmarks = L__default["default"].Control.extend(
    /**  @lends Bookmarks.prototype */ {
      ...
      initialize: function (options) {
        ...
        L__default["default"].Control.prototype.initialize.call(this, this.options);
      },
       ...
       */
      onAdd: function (map) {
        var container = (this._container = L__default["default"].DomUtil.create(
          "div",
          this.options.containerClass
        ));

        L__default["default"].DomEvent.disableClickPropagation(container).disableScrollPropagation(
          container
        );
        container.innerHTML =
          '<div class="' +
        ...
        var wrapper = L__default["default"].DomUtil.create(
          "div",
        ...
        L__default["default"].DomEvent.on(container, "click", this._onClick, this).on(
          container,
          "contextmenu",
          L__default["default"].DomEvent.stopPropagation
        );
      ...
      onRemove: function (map) {
        ...
        if (this.options.addNewOption) {
          L__default["default"].DomEvent.off(
      ...
      _createList: function (bookmarks) {
        ...
        this._listwrapper = L__default["default"].DomUtil.create(
          "div",
          this.options.listWrapperClass,
          this._container
        );
        this._list = L__default["default"].DomUtil.create(
          "ul",
        ...
        if (L__default["default"].Util.isArray(bookmarks)) {
          this._appendItems(bookmarks);
        } else if (typeof bookmarks === "function") {
          this._appendItems(bookmarks());
        } else {
          this._storage.getAllItems(function (bookmarks) { return this$1$1._appendItems(bookmarks); });
        }
      },
      ...
      _setEmptyListContent: function () {
        this._list.innerHTML = substitute(
          ...
          L__default["default"].Util.extend(this.options.bookmarkTemplateOptions, {
            data: {
      ...
      _initLayout: function () {
        ...
        if (this.options.position === "topleft") {
          L__default["default"].DomUtil.addClass(this._container, "leaflet-bookmarks-to-right");
        }
        if (this.options.addNewOption) {
          var addButton = L__default["default"].DomUtil.create(
            "div",
            this.options.addBookmarkButtonCss
          );
          if (this._addButton === null) {
            ...
            addButton.innerHTML =
              ...
              "</span>";
            L__default["default"].DomEvent.on(addButton, "click", this._onAddButtonPressed, this);
          }
        }
      },
      ...
      _scrollToLast: function () {
        ...
        function scroll(timestamp) {
          ...
          if (pos !== targetVal) {
            L__default["default"].Util.requestAnimFrame(scroll);
          }
        }
        L__default["default"].Util.requestAnimFrame(scroll);
      },
       ...
       */
      expand: function () {
        L__default["default"].DomUtil.addClass(this._container, this.options.expandedClass);
       ...
       */
      collapse: function () {
        L__default["default"].DomUtil.removeClass(this._container, this.options.expandedClass);
        this._isCollapsed = true;
      },
      ...
      _onClick: function (evt) {
        var expanded = L__default["default"].DomUtil.hasClass(
          this._container,
        ...
        if (expanded) {
          ...
          while (target !== this._container) {
            if (
              L__default["default"].DomUtil.hasClass(target, this.options.headerClass) ||
              L__default["default"].DomUtil.hasClass(target, this.options.listWrapperClass)
            ) {
              this.collapse();
              break;
            }
      ...
      _onBookmarkAddStart: function (evt) {
        ...
        this._marker = new L__default["default"].Marker(evt.latlng, {
          icon: this.options.icon || new L__default["default"].Icon.Default(),
          draggable: true,
          riseOnHover: true,
        }).addTo(this._map);
        ...
        // open form
        this._popup = new L__default["default"].Control.Bookmarks.FormPopup(
          L__default["default"].Util.extend(this.options.formPopup, {
            mode: L__default["default"].Control.Bookmarks.FormPopup.modes.CREATE,
          }),
          this._marker,
          this,
          L__default["default"].Util.extend({}, evt.data, this.options.defaultBookmarkOptions)
        ).addTo(this._map);
      },
      ...
      _cleanBookmark: function (bookmark) {
        if (!L__default["default"].Util.isArray(bookmark.latlng)) {
      ...
      _bookmarkOptions: function (bookmark) {
        var coords = L__default["default"].latLng(bookmark.latlng);
        var marker = (this._marker = this._createMarker(coords, bookmark));
        // open form
        this._popup = new L__default["default"].Control.Bookmarks.FormPopup(
          L__default["default"].Util.extend(this.options.formPopup, {
            mode: L__default["default"].Control.Bookmarks.FormPopup.modes.OPTIONS,
          }),
          marker,
          this,
          bookmark
      ...
      _editBookmark: function (bookmark) {
        ...
        this._popup = new L__default["default"].Control.Bookmarks.FormPopup(
          L__default["default"].Util.extend(this.options.formPopup, {
            mode: L__default["default"].Control.Bookmarks.FormPopup.modes.UPDATE,
          }),
          marker,
          this,
          bookmark
      ...
      _createMarker: function (coords, bookmark) {
        ...
        var marker = new L__default["default"].Marker(coords, {
          icon: this.options.icon || new L__default["default"].Icon.Default(),
          riseOnHover: true,
        }).addTo(this._map);
        ...
        marker
          .on("popupclose", function () { return this$1$1._map.removeLayer(this$1$1); })
          .on("remove", function () { return this$1$1._map.off("bookmark:removed", removeIfRemoved); });
        return marker;
      },
      ...
      _showBookmark: function (bookmark) {
        ...
        var popup = new L__default["default"].Control.Bookmarks.FormPopup(
          L__default["default"].Util.extend(this.options.formPopup, {
            mode: L__default["default"].Control.Bookmarks.FormPopup.modes.SHOW,
          }),
          marker,
          this,
          bookmark
      ...
      _removeBookmark: function (bookmark) {
        ...
        var remove = function (proceed) {
          if (!proceed) { return this$1$1._showBookmark(bookmark); }

          this$1$1._data.splice(this$1$1._data.indexOf(bookmark), 1);
          this$1$1._storage.removeItem(bookmark.id, function (bookmark) {
            this$1$1._onBookmarkRemoved(bookmark);
          });
        };
      ...
      _onBookmarkRemoved: function (bookmark) {
        ...
        if (li) {
          L__default["default"].DomUtil.setOpacity(li, 0);
          setTimeout(function () {
            if (li.parentNode) { li.parentNode.removeChild(li); }
            if (this$1$1._data.length === 0) { this$1$1._setEmptyListContent(); }
          }, 250);
        }
      },
      ...
      _onBookmarkClick: function (evt) {
        ...
        if (!bookmark) { return; }
        L__default["default"].DomEvent.stopPropagation(evt);

        // remove button hit
        if (
          L__default["default"].DomUtil.hasClass(
      ...
      bookmarkToFeature: function (bookmark) {
        ...
        return L__default["default"].GeoJSON.getFeature(
          {
            feature: {
              type: "Feature",
              id: bookmark.id,
      ...
      _getBookmarkCoords: function (bookmark) {
        if (bookmark.latlng instanceof L__default["default"].LatLng) {
      ...
      toGeoJSON: function () {
        ...
        return {
          ...
          features: (function (data) {
            ...
            for (var i = 0, len = data.length; i < len; i++) {
              if (!data[i].divider) {
                result.push(this$1$1.bookmarkToFeature(data[i]));
              }
            }
            return result;
          })(this._data),
  ...
  L__default["default"].Control.Bookmarks = Bookmarks;
