...
(function () {
	...
	*/
	...
	(function () {
		...
		var ie = 'ActiveXObject' in window,
		    ...
		    mobile = typeof orientation !== undefined$1 + '',
	...
	L.DomUtil = {
		...
		_setClass: function (el, name) {
			if (el.className.baseVal === undefined$1) {
				el.className = name;
			} else {
		...
		_getClass: function (el) {
			return el.className.baseVal === undefined$1 ? el.className : el.className.baseVal;
		},
	...
	L.Map = L.Class.extend({
		...
		initialize: function (id, options) { // (HTMLElement or String, Object)
			...
			if (options.center && options.zoom !== undefined$1) {
		...
		setView: function (center, zoom) {
			zoom = zoom === undefined$1 ? this.getZoom() : zoom;
		...
		remove: function () {
			...
			try {
				...
				this._container._leaflet = undefined$1;
			}
		...
		getMinZoom: function () {
			return this.options.minZoom === undefined$1 ?
				(this._layersMinZoom === undefined$1 ? 0 : this._layersMinZoom) :
				this.options.minZoom;
		},

		getMaxZoom: function () {
			return this.options.maxZoom === undefined$1 ?
				(this._layersMaxZoom === undefined$1 ? Infinity : this._layersMaxZoom) :
		...
		project: function (latlng, zoom) { // (LatLng[, Number]) -> Point
			zoom = zoom === undefined$1 ? this._zoom : zoom;
		...
		_updateZoomLevels: function () {
			...
			if (i === undefined$1) { // we have no tilelayers
				this._layersMaxZoom = this._layersMinZoom = undefined$1;
			} else {
	...
	L.TileLayer = L.Class.extend({
		...
		_updateZIndex: function () {
			if (this._container && this.options.zIndex !== undefined$1) {
		...
		_createTile: function () {
			...
			if (L.Browser.ielt9 && this.options.opacity !== undefined$1) {
	...
	L.LineUtil = {
		...
		_simplifyDP: function (points, sqTolerance) {
			...
			var len = points.length,
			    ArrayConstructor = typeof Uint8Array !== undefined$1 + '' ? Uint8Array : Array,
	...
	*/
	...
	L.Map.include({
		...
		setView: function (center, zoom, options) {
			...
			zoom = zoom === undefined$1 ? this._zoom : this._limitZoom(zoom);
			...
			if (this._loaded && !options.reset && options !== true) {
				...
				if (options.animate !== undefined$1) {
	...
	*/
	...
	var FormPopup = leafletSrc.Popup.extend( /** @lends FormPopup.prototype */ {
	  ...
	  _calculateOffset: function(source, options) {
	    let anchor = leafletSrc.point(source.options.icon.options.popupAnchor || [0, 0]);
	...
	*/
	...
	var L$1 = commonjsGlobal.L || leafletSrc;


	var leafletModal = L$1.Map.Modal;

	leafletSrc.Icon.Default.imagePath = "http://cdn.leafletjs.com/leaflet-0.7/images";

	var map = window.map = new leafletSrc.Map('map', {
	  contextmenu: true,
	  contextmenuItems: [{
