$_mod.def("/leaflet-bookmarks$0.2.5/test/bookmarks.test", function(require, exports, module, __filename, __dirname) { "use strict";

var L = require('/leaflet$0.7.7/dist/leaflet-src'/*'leaflet'*/);
var Bookmarks = require('/leaflet-bookmarks$0.2.5/dist/Leaflet.Bookmarks'/*'../dist/Leaflet.Bookmarks.js'*/);
var { assert } = require('/chai$4.2.0/index'/*'chai'*/);
